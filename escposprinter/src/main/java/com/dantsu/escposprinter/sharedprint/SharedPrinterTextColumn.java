...
public class SharedPrinterTextColumn {
    ...
    private SharedPrinterTextParserLine textParserLine;
    private ISharedPrinterTextParserElement[] elements = new ISharedPrinterTextParserElement[0];
     ...
     */
    public SharedPrinterTextColumn(SharedPrinterTextParserLine textParserLine, String textColumn) throws EscPosParserException, EscPosBarcodeException, EscPosEncodingException {
        this.textParserLine = textParserLine;
        SharedPrintTextParser textParser = this.textParserLine.getTextParser();
        ...
        if (!isImgOrBarcodeLine) {
            ...
            for (ISharedPrinterTextParserElement textParserElement : this.elements) {
            ...
            if (leftSpace > 0) {
                Log.d("Log404", "Printing8:   " + SharedPrinterTextColumn.generateSpace(leftSpace));

                this.prependString(SharedPrinterTextColumn.generateSpace(leftSpace), EscPosPrinterCommands.TEXT_SIZE_NORMAL, textColorStartColumn, textReverseColorStartColumn, EscPosPrinterCommands.TEXT_WEIGHT_NORMAL, textUnderlineStartColumn, textDoubleStrikeStartColumn);
            }
            if (rightSpace > 0) {
                Log.d("Log404", "Printing9:   " + SharedPrinterTextColumn.generateSpace(rightSpace));

                this.appendString(SharedPrinterTextColumn.generateSpace(rightSpace), EscPosPrinterCommands.TEXT_SIZE_NORMAL, textParser.getLastTextColor(), textParser.getLastTextReverseColor(), EscPosPrinterCommands.TEXT_WEIGHT_NORMAL, textParser.getLastTextUnderline(), textParser.getLastTextDoubleStrike());
            }
    ...
    private SharedPrinterTextColumn prependString(String text) {
        SharedPrintTextParser textParser = this.textParserLine.getTextParser();
    ...
    private SharedPrinterTextColumn prependString(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) {
        return this.prependElement(new SharedPrinterTextParserString(this, text, textSize, textColor, textReverseColor, textBold, textUnderline, textDoubleStrike));
    }

    private SharedPrinterTextColumn appendString(String text) {
        SharedPrintTextParser textParser = this.textParserLine.getTextParser();
    ...
    private SharedPrinterTextColumn appendString(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) {
        SharedPrinterSize printer = this.textParserLine.getTextParser().getPrinter();
        return this.appendElement(new SharedPrinterTextParserString(this, text, textSize, textColor, textReverseColor, textBold, textUnderline, textDoubleStrike));
    }

    private SharedPrinterTextColumn prependImage(String textAlign, String hexString) {
        return this.prependElement(new SharedPrinterTextParserImg(this, textAlign, hexString));
    }

    private SharedPrinterTextColumn appendImage(String textAlign, String hexString) {
        return this.appendElement(new SharedPrinterTextParserImg(this, textAlign, hexString));
    }

    private SharedPrinterTextColumn prependBarcode(String textAlign, Hashtable<String, String> barcodeAttributes, String code) throws EscPosParserException, EscPosBarcodeException {
        return this.prependElement(new SharedPrinterTextParserBarcode(this, textAlign, barcodeAttributes, code));
    }

    private SharedPrinterTextColumn appendBarcode(String textAlign, Hashtable<String, String> barcodeAttributes, String code) throws EscPosParserException, EscPosBarcodeException {
        return this.appendElement(new SharedPrinterTextParserBarcode(this, textAlign, barcodeAttributes, code));
    }

    private SharedPrinterTextColumn prependQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException, EscPosBarcodeException {
        return this.prependElement(new SharedPrinterTextParserBarcode(this, textAlign, qrCodeAttributes, data));
    }

    private SharedPrinterTextColumn appendQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException, EscPosBarcodeException {
        return this.appendElement(new SharedPrinterTextParserQRCode(this, textAlign, qrCodeAttributes, data));
    }

    private SharedPrinterTextColumn prependElement(ISharedPrinterTextParserElement element) {
        ISharedPrinterTextParserElement[] elementsTmp = new ISharedPrinterTextParserElement[this.elements.length + 1];
    ...
    private SharedPrinterTextColumn appendElement(ISharedPrinterTextParserElement element) {
        ISharedPrinterTextParserElement[] elementsTmp = new ISharedPrinterTextParserElement[this.elements.length + 1];
    ...
    public SharedPrinterTextParserLine getLine() {
        return this.textParserLine;
    }

    public ISharedPrinterTextParserElement[] getElements() {
